  ...
  return (
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="max-w-xl mx-auto text-center">
            <div class="inline-flex px-5 py-1.5 mx-auto rounded-full bg-gradient-to-r from-fuchsia-600 to-purple-400">
                <p class="text-sm font-semibold tracking-widest text-white uppercase">Trained With Kernel Ridge Regression</p>
            </div>
            <h2 class="mt-6 text-3xl font-bold leading-tight text-gray-800 sm:text-4xl lg:text-5xl">Future Oil Price Powered by Machine Learning</h2>
            <p class="mt-6 text-base leading-relaxed text-white">Let powerful A.I future-proof your business and help you always stay one step ahead of your competition.</p>
        </div>

        <div class="grid grid-cols-1 gap-5 mt-12 sm:grid-cols-3 lg:mt-20 lg:gap-x-12">
            <div class="rounded transition-all duration-200 bg-blue-100 hover:shadow-xl">
            ...
            <div class="bg-blue-100 rounded transition-all duration-200 hover:shadow-xl">
                <div class="py-10 px-9">
                    <svg class="w-16 h-16 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                    <h3 class="mt-8 text-lg font-semibold text-black">Overfitting & Secure Data</h3>
                    <p class="mt-4 text-base text-gray-600">Overfitting is avoided inherently with the Kernel Ridge Regression Model allowing high variance and multiple variables. Data is handled strictly through APIs that keep the data flow pipelines away from databases.</p>
                </div>
            </div>
        </div>
    </div>
